// ============================================================
// FILE: src/components/trainer/TaskResults/TaskResultsPage.jsx
// PURPOSE: Trainer views student task evaluation results
// ============================================================
...
const TaskResultsPage = () => {
    ...
    const fetchBatches = async () => {
        ...
        setError('');
        try {
            const response = await getStudentTaskResultFilters('trainer', trainerId);
    ...
    const handleBatchChange = async (e) => {
        ...
        try {
            const response = await getStudentTaskResultFilters('trainer', trainerId, { batch_id: batchId });
    ...
    const handleSessionChange = async (e) => {
        ...
        try {
            const response = await getStudentTaskResultFilters('trainer', trainerId, { batch_id: selectedBatch, session_id: sessionId });
    ...
    const fetchResults = async (batchId, sessionId, taskId) => {
        ...
        try {
            ...
            const response = await getStudentTaskResults('trainer', trainerId, params);
