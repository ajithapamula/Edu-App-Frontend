// UPDATED: App.jsx — Landing page as default, Sign In → Login page
// src/App.jsx
...
import TaskReviewsList from "./components/trainer/TaskReviews/TaskReviewsList";
import ViewTaskReview from "./components/trainer/TaskReviews/ViewTaskReview";
import TaskResultsPage from "./components/trainer/TaskResults/TaskResultsPage";
import BatchList from "./components/trainer/Batches/Batchlist";
import BatchStudents from "./components/trainer/Batches/BatchStudents";
...
import MentorTaskResultsPage from "./components/mentor/TaskResults/taskresultspage";
import MentorBatchList from "./components/mentor/Batches/BatchList";
import MentorBatchStudents from "./components/mentor/Batches/BatchStudents";
import MentorSessionsList from "./components/mentor/Sessions/SessionList";
...
import StudentSessionsList from "./components/student/Sessions/SessionsList";

// Task Evaluations
import TaskEvaluationsPage from "./components/student/TaskEvaluations/TaskEvaluationsPage";
import ViewTaskEvaluation from "./components/student/TaskEvaluations/ViewTaskEvaluation";
...
// ─── NEW: Student Results Components ───
import DailyStandupResults from "./components/student/Results/DailyStandupResults";
import WeeklyInterviewResults from "./components/student/Results/WeeklyInterviewResults";
...
// ─── SmartRedirect: for authenticated users hitting /redirect ───
const SmartRedirect = () => {
    ...
    <AuthProvider>
      <ThemeProvider>
        <Router>
          <div className="App">
            <Routes>
              {/* ─── NEW: Landing Page as default route ─── */}
              ...
              />
              <Route
                path="/trainer/batches/:batchId/students"
                element={
                  <PrivateRoute allowedRoles={["trainer"]}>
                    <Layout>
                      <BatchStudents />
              ...
              />
              {/* Batch-scoped Session Routes */}
              <Route path="/trainer/batches/:batchId/sessions" element={<PrivateRoute allowedRoles={["trainer"]}><Layout><SessionsList /></Layout></PrivateRoute>} />
              <Route path="/trainer/batches/:batchId/sessions/create" element={<PrivateRoute allowedRoles={["trainer"]}><Layout><AddSession /></Layout></PrivateRoute>} />
              <Route path="/trainer/batches/:batchId/sessions/view/:id" element={<PrivateRoute allowedRoles={["trainer"]}><Layout><ViewSession /></Layout></PrivateRoute>} />
              <Route path="/trainer/batches/:batchId/sessions/edit/:id" element={<PrivateRoute allowedRoles={["trainer"]}><Layout><AddSession /></Layout></PrivateRoute>} />
              ...
              {/* Trainer Task Reviews Routes */}
              <Route
                path="/trainer/task-reviews"
                element={
                  <PrivateRoute allowedRoles={["trainer"]}>
                    <Layout>
                      <TaskReviewsList />
              ...
              />
              <Route
                path="/trainer/task-reviews/view/:id"
                element={
                  <PrivateRoute allowedRoles={["trainer"]}>
                    <Layout>
                      <ViewTaskReview />
              ...
              {/* Trainer - Student Task Results */}
              <Route
                path="/trainer/task-results"
                element={
                  <PrivateRoute allowedRoles={["trainer"]}>
                    <Layout>
                      <TaskResultsPage />
              ...
              />
              <Route
                path="/mentor/batches/:batchId/students"
                element={
                  <PrivateRoute allowedRoles={["mentor"]}>
                    <Layout>
                      <MentorBatchStudents />
              ...
              />
              {/* Mentor Sessions Route */}
              <Route
                path="/mentor/batches/:batchId/sessions"
                element={
                  <PrivateRoute allowedRoles={["mentor"]}>
                    <Layout>
                      <MentorSessionsList />
              ...
              />
              {/* Mentor - Student Task Results */}
              <Route
                path="/mentor/task-results"
                element={
                  <PrivateRoute allowedRoles={["mentor"]}>
                    <Layout>
                      <MentorTaskResultsPage />
                    </Layout>
                  </PrivateRoute>
                }
              />
              ...
              />
              <Route path="/student/sessions" element={<PrivateRoute allowedRoles={["student"]}><Layout><StudentSessionsList /></Layout></PrivateRoute>} />
              ...
              {/* Student Task Evaluations Routes */}
              <Route
                path="/student/task-evaluations"
                element={
                  <PrivateRoute allowedRoles={["student"]}>
                    <Layout>
                      <TaskEvaluationsPage />
              ...
              />
              <Route
                path="/student/task-evaluations/view/:submissionId"
                element={
                  <PrivateRoute allowedRoles={["student"]}>
                    <Layout>
                      <ViewTaskEvaluation />
              ...
              <Route
                path="/student/results/daily-standups"
                element={
                  <PrivateRoute allowedRoles={["student"]}>
                    <Layout>
                      <DailyStandupResults />
              ...
              <Route
  path="/student/results/mock-interviews"
  element={
    <PrivateRoute allowedRoles={["student"]}>
      <Layout><WeeklyInterviewResults /></Layout>
    </PrivateRoute>
  }
/>
              <Route path="/student/mock-tests/instructions" element={<TestInstructions />} />
              
              {/* Convenience redirects */}
              <Route path="/student/interviews" element={<Navigate to="/student/mock-interviews" replace />} />
              <Route path="/student/standups" element={<Navigate to="/student/daily-standups" replace />} />
              <Route path="/student/tests" element={<Navigate to="/student/mock-tests" replace />} />
              <Route path="/student/documents" element={<Navigate to="/student/course-documents" replace />} />
              <Route path="/student/recordings" element={<Navigate to="/student/session-recordings" replace />} />
              <Route path="/student/submissions" element={<Navigate to="/student/task-submissions" replace />} />
              
              {/* Fallback routes */}
              <Route path="/student/interview/*" element={<Navigate to="/student/mock-interviews" replace />} />
              <Route path="/weekly_interview/*" element={<Navigate to="/student/mock-interviews" replace />} />
